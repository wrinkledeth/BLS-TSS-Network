...
def print_keypair(mnemonic, index, passphrase=""):
    ...
    print("\nIndex: {}".format(index))
    print("Public key: {}".format(str(binascii.hexlify(public_key), "utf-8")))
    print("Private key: {}".format(str(binascii.hexlify(private_key), "utf-8")))
